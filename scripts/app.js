...
//document.querySelector('.container').removeAttribute('hidden');
  ...
  app.updateTransportCard = function(data) {
    var dataLastUpdated = new Date(data.created);
    var mode = data.mode;
    var line = data.line;
    var stop = data.stop;
  ...
  var initialTransport = {
    key: '1',
    label: 'Maggs St - 906',
    created: '2016-11-15T01:00:00Z',
    mode: 2,
    line: 8596,
    stop: 21301,
    direction: 40
  ...
  // CCTODO - use indexeddb instead of localstorage
  ...
  if (app.selectedCities) {
    ...
    app.selectedCities.forEach(function(city) {
      console.log('app.selectedCities, city.label: ' + city.label);
